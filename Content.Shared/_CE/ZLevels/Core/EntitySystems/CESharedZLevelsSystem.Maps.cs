...
public abstract partial class CESharedZLevelsSystem
{
    ...
    public bool TryGetMapNetwork(EntityUid mapUid, out Entity<CEZMapNetworkComponent> zLevel)
    {
        ...
        // Adding the component to an already initialized map raises MapInitEvent right away, so this
        // runs before the network uid is filled in. That is not a terminated network, just a fresh map
    ...
    /// cost of their depth difference, scaled by <see cref="CCVars.CEZLevelsVerticalDistanceScale"/>.
    ...
    public bool TryGetEffectiveDistance(EntityUid a, EntityUid b, out float distance)
    {
        ...
        var vertical = zOffset * ZLevelOffset * _config.GetCVar(CCVars.CEZLevelsVerticalDistanceScale);
